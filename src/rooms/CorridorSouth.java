...
public class CorridorSouth extends Corridor {
	public CorridorSouth(int x1, int y1, int x2, int y2, String s) {
		this.description = s;
	...
	public void printOn(Tile[][] tab) {
		...
		tab[this.p1.y][this.p1.x+1] = TileFactory.getInstance().createTileDoor();
	}
}
