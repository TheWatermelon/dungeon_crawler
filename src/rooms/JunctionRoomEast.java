...
public class JunctionRoomEast extends JunctionRoom {
	public JunctionRoomEast(int x1, int y1, int x2, int y2, int doorPos, String s) {
	...
	public void printOn(Tile[][] tab) {
		...
		// Door
		tab[this.door][this.p1.x] = TileFactory.getInstance().createTileDoor();
	}
}
