...
public class CorridorWest extends Corridor {
	public CorridorWest(int x1, int y1, int x2, int y2, String s) {
		this.description = s;
	...
	public void printOn(Tile[][] tab) {
		...
		tab[this.p1.y+1][this.p2.x] = TileFactory.getInstance().createTileDoor();
	}
}
