...
public class JunctionRoomSouth extends JunctionRoom {
	public JunctionRoomSouth(int x1, int y1, int x2, int y2, int doorPos, String s) {
	...
	public void printOn(Tile[][] tab) {
		...
		// Door
		tab[this.p1.y][this.door] = TileFactory.getInstance().createTileDoor();
	}
}
