...
public class JunctionRoomWest extends JunctionRoom {
	public JunctionRoomWest(int x1, int y1, int x2, int y2, int doorPos, String s) {
	...
	public void printOn(Tile[][] tab) {
		...
		// Door
		tab[this.door][this.p2.x] = TileFactory.getInstance().createTileDoor();
	}
}
